...
/**
  @title Contract that Uses Data Struct of DoublyLinkedList Library for Testing
  @author DigixGlobal Pte Ltd
*/
contract TestDoublyLinkedList {
  using DoublyLinkedList for DoublyLinkedList.Data;
  DoublyLinkedList.Data testData;
  ...
  /**
  @notice Returns the total number of collection in `testData`
  @return {"_count": "The total number of collection in `testData`"}
  */
  ...
  /**
  @notice Returns the first index of `testData`
  @return {"_first_index": "First index of `testData`"}
  */
  ...
  /**
  @notice Returns the last index of `testData`
  @return {"_first_index": "Last index of `testData`"}
  */
  ...
  @return {"_count": "Total number of items in `testData`"}
  */
  ...
  /**
  @notice Returns the previous index in `testData` based on the given `_item_index`
  @param _item_index Starting index of the item
  @return {"_previous_index": "Index of the previous item of `testData`"}
  */
  ...
  /**
  @notice Returns the next index in `testData` based on the given `_item_index`
  @param _item_index Starting index of the item
  @return {"_next_index": "Index of the next item of `testData`"}
  */
