...
contract('IndexedAddressIteratorController', function () {
  ...
  describe('get_first_from_indexed_uints_dll', function () {
  ...
  describe('get_last_from_indexed_uints_dll', function () {
  ...
  describe('get_next_from_indexed_uints_dll', function () {
  ...
  describe('get_previous_from_indexed_uints_dll', function () {
  ...
  describe('get_indexed_uints_dll_total', function () {
