...
contract('IndexedBytesIteratorStorage', function () {
  ...
  describe('read_first_from_indexed_bytesarray', function () {
  ...
  describe('read_last_from_indexed_bytesarray', function () {
  ...
  describe('read_next_from_indexed_bytesarray', function () {
  ...
  describe('read_previous_from_indexed_bytesarray', function () {
  ...
  describe('read_total_indexed_bytesarray', function () {
